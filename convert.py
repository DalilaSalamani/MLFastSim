...
def main(argv):
    ...
    onnx_model = tf2onnx.convert.from_keras(keras_model, output_path=output_path)
    ...
    result = sess.run(None, {'input_9': input_1, 'input_6': input_2, 'input_7': input_3, 'input_8': input_4})
