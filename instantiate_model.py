...
from constants import BATCH_SIZE, ORIGINAL_DIM, INTERMEDIATE_DIM1, INTERMEDIATE_DIM2, INTERMEDIATE_DIM3, \
    INTERMEDIATE_DIM4, LATENT_DIM, EPOCHS, ACTIVATION, OUT_ACTIVATION, VALIDATION_SPLIT, \
    KERNEL_INITIALIZER, BIAS_INITIALIZER, EARLY_STOP, CHECKPOINT_DIR, SAVE_FREQ, LEARNING_RATE, \
    OPTIMIZER_TYPE
