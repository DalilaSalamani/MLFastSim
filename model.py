...
class VAE:
    def __init__(self, **kwargs):
        ...
        x_recoDeco = x_reco(
            (((decoL1_BN(decoL1(decoL2_BN(decoL2(decoL3_BN(decoL3(decoL4_BN(decoL4(zDecoInput))))))))))))
        ...
        self.vae = Model(inputs=[xIn, eCond, angleCond, GeoCond, eps],
                         outputs=[self.decoder(self.encoder([xIn, eCond, angleCond, GeoCond, eps]))])
