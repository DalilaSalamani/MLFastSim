...
class VAE(Model):
    ...
    def _perform_step(self, data: Any) -> Tuple[float, float, float]:
        ...
        loss = ORIGINAL_DIM * reconstruction_loss + kl_loss
    ...
    def train_step(self, data: Any) -> Dict[str, object]:
        with tf.GradientTape() as tape:
            ...
            loss, reconstruction_loss, kl_loss = self._perform_step(data)
    ...
    def test_step(self, data: Any) -> Dict[str, object]:
        ...
        val_loss, val_reconstruction_loss, val_kl_loss = self._perform_step(data)
...
class VAEHandler:
    ...
    def __init__(self, original_dim: int = ORIGINAL_DIM, latent_dim: int = LATENT_DIM, batch_size: int = BATCH_SIZE,
        ...
        self.model.compile(optimizer=optimizer,
                           metrics=[self.model.loss_tracker, self.model.val_loss_tracker])
